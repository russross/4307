...
--   115310      William Bro  1         
--   158         Tom Hanks    1         
--   129         Tom Cruise   1         
--   209         Tim Robbins  1         
--   1417242     Sheldon Tur  1         
--   576         Sean Penn    1         
--   5377        Sam Rockwel  1         
--   165         Ron Howard   1         
--   ...
--   718031      Al Reinert   1         
--   815070      Aaron Sorki  1         
--   5939164     Zazie Beetz  2         
--   672015      Zak Penn     2         
--   340260      Zach Grenie  2         
--   1433        Yaphet Kott  2         
--   437         Woody Harre  2         
--   583         Wolfgang Pe  2         
--   525742      Wolfgang Lu  2         
--   343165      Winston Gro  2         
--   ...
--
-- write your query here:
WITH RECURSIVE bacon(person_id, n) AS
(
    SELECT person_id, 0 FROM people WHERE name = 'Kevin Bacon'

    UNION

    SELECT new.person_id, bacon.n+1
    FROM crew AS new
    JOIN crew AS old ON old.title_id = new.title_id
    JOIN bacon ON bacon.person_id = old.person_id
    WHERE new.person_id <> old.person_id AND bacon.n < 4
)

SELECT people.person_id, people.name, MIN(n) AS n
FROM bacon
