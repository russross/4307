...
SELECT course_id FROM section WHERE semester = 'Fall' AND year = 2017 UNION
...
--
-- write your query on the next line
SELECT course_id FROM section WHERE semester = 'Fall' AND year = 2017 INTERSECT
SELECT course_id FROM section WHERE semester = 'Spring' AND year = 2018;
...
--
-- write your query on the next line
SELECT course_id FROM section WHERE semester = 'Fall' AND year = 2017 EXCEPT
SELECT course_id FROM section WHERE semester = 'Spring' AND year = 2018;
